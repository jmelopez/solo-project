...
<body>
    ...
    <div class="header">
        ...
        <div class="form">
            <form:form action="/listing/edit/${listing.id}" method="POST" modelAttribute="listing">
                ...
                <div class="form_input row mb-3 gy-3">
                    ...
                    <div class="col-sm-11">
                        <form:input path="title" class="form-control" value="${listing.title}"/>
                    </div>
					
                    <form:label path="address" class="col-sm-1 col-form-label fw-bold">Address:</form:label>
                    <div class="col-sm-11">
                        <form:input path="address" class="form-control" value="${listing.address}"/>
                    </div>
					
                    <form:label path="city" class="col-sm-1 col-form-label fw-bold">City:</form:label>
                    <div class="col-sm-4">
                        <form:input path="city" class="form-control" value="${listing.city}"/>
                    </div>
					
                    <form:label path="state" class="col-sm-1 col-form-label fw-bold">State:</form:label>
                    <div class="col-sm-1">
                        <form:input path="state" class="form-control" value="${listing.state}"/>
                    </div>
					
                    <form:label path="zipcode" class="col-sm-2 col-form-label fw-bold">ZipCode:</form:label>
                    <div class="col-sm-3">
                        <form:input path="zipcode" class="form-control" value="${listing.zipcode}"/>
                    </div>					
					
                    <form:label path="date" class="col-sm-1 col-form-label fw-bold">When:</form:label>
                    <div class="col-sm-3">
                        <form:input path="date" type="date" class="form-control" value="${listing.date}"/>
                    </div>
					
                    <form:label path="start" class="col-sm-2 col-form-label fw-bold">Start Time:</form:label>
                    <div class="col-sm-2">
                        <form:input path="start" type="time" class="form-control" value="${listing.start}"/>
                    </div>

                    <form:label path="end" class="col-sm-2 col-form-label fw-bold">End Time:</form:label>
                    <div class="col-sm-2">
                        <form:input path="end" type="time" class="form-control" value="${listing.end}"/>
                    </div>

                    <form:label path="description" class="col-sm-1 col-form-label fw-bold">Details:</form:label>
                    <div class="col-sm-11">
                        <form:textarea rows="2" class="form-control" path="description" value="${listing.description}"/>
                    </div>
